...
$req = $cnx->prepare("SELECT * from expert");
$req->execute(array()); 
          ...
          <div class="col-md-12">
            ...
            <form method="post" action="">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Nos experts</h4>
                <hr>
                <thead>
                  <tr>
                    <th><i class="fa fa-group"></i> Nom</th>
                    <th class="hidden-phone"><i class="fa fa-female"></i> Image</th>
                    <th></th>
                  </tr>
                </thead>
                ...
                ?>
                 ...
                 <td> <?php echo '<img src="'.$item['image'].'"> </img>' ?></td>
                  </td>
                  </tr>
                  <?php
                 }
                ...
                <div class="form-group row" >
                     ...
                     <div class="col-sm-10">
                         <input type="button" onclick="window.location.href ='ajout-experts.php';" name="ajout" class="btn btn-lg btn-primary" value="ajouter">
                    </div>
                </div> 
              </div>
            <!-- /content-panel -->
