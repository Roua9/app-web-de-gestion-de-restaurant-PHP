...
$req = $cnx->prepare("SELECT * from inscri");
$req->execute(array()); 
          ...
          <div class="col-md-12">
            ...
            <form method="post" action="">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Nos Clients</h4>
                <hr>
                <thead>
                  <tr>
                    <th><i class="fa fa-group"></i> Nom</th>
                    <th class="hidden-phone"><i class="fa fa-female"></i> Prénom</th>
                ...
                ?>
                 ...
                 <td> <?php echo $item['email']; ?> </td>
                  ...
                  <!-- <td> <a href="<?php"supp-clients.php?id='. $item['id']. '"?>" >
...
<?php
                  ...
                  $req = $cnx->prepare("DELETE * from inscri WHERE id=?");
                  $req->execute(array($id));*/ 
                  ?>
              <!--  <td> <a> <button class="btn btn-danger btn-xs"  
                onclick="location.href='supp-clients.php?id=" .  $item['id']  . "' " >
